...
#PCA_GRADDESC:
#Minimises number of hoppings in the tight-binding model with nesterov gradient descen.
...
lambda_1vec = [4.0]
runvec = [61000] #Increase by 1 for every run !!!! #Declared
...
iterations = 20 #Iterations of Gradient descent (e.g. 1200)
